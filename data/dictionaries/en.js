...
const en = {
  ...
  services: {
    ...
    items: [
      ...
      },
      {
        ...
        includes: ["RAG chatbots & assistants", "Natural-language-to-SQL", "Agent & prompt workflows", "Workflow automation & integrations"],
      ...
      },
      {
        ...
        blurb: "End-to-end deployment on Google Cloud / AWS with containerisation, CI/CD, infrastructure-as-code, and observability.",
        includes: ["GCP / AWS deployment", "Containerisation & orchestration", "CI/CD pipelines", "Monitoring & cost control"],
      ...
      items: [
        {
          ...
          features: ["1 responsive page, built to order", "Modern design from a curated template", "WhatsApp, Maps & social buttons", "Free hosting + HTTPS on a free subdomain", "2–3 day turnaround · 1 revision"],
        },
        {
        ...
        },
        {
          ...
          features: ["Up to 10 pages + blog", "Admin panel / CMS for managing content", "Full SEO, sitemap, visitor analytics", "WhatsApp Business / payment link / Maps integrations", "2–3 week turnaround · 3 revisions"],
        },
        {
          name: "Web App / System",
          price: "IDR 5M",
          desc: "A custom web application: management systems, booking, inventory, or internal dashboards.",
          features: ["Multi-role auth + managed database", "Dashboards, reports & data export", "REST API + integrations with your other systems", "Cloud deployment + basic monitoring", "4–6 week turnaround · 1-month bugfix warranty"],
        },
      ],
      enterprise: {
        name: "AI, Automation & Enterprise",
        price: "Custom",
        desc: "Document-grounded AI chatbots (RAG), NL2SQL, workflow automation, computer vision/IoT, or multi-system enterprise integrations — scoped and estimated after a free discovery session.",
        features: ["Requirements analysis & architecture design", "LLM/RAG, agent workflows, quality evaluation", "Data pipelines, streaming & scheduled workflows (GCP/AWS)", "Security, monitoring & documented handover"],
      },
  ...
  detail: {
    ...
    banner: "The real product is private — the UI, endpoints & architecture shown here are illustrative.",
