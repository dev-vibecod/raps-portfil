...
const id = {
  ...
  services: {
    ...
    items: [
      ...
      },
      {
        ...
        includes: ["Chatbot & asisten RAG", "Natural-language-to-SQL", "Alur agent & prompt", "Otomasi alur kerja & integrasi"],
      ...
      },
      {
        ...
        blurb: "Deployment end-to-end di Google Cloud / AWS dengan containerisasi, CI/CD, infrastructure-as-code, dan observability.",
        includes: ["Deployment GCP / AWS", "Containerisasi & orkestrasi", "Pipeline CI/CD", "Monitoring & kontrol biaya"],
      ...
      items: [
        {
          ...
          features: ["1 halaman responsif, dibuat sesuai pesanan", "Desain modern berbasis template pilihan", "Tombol WhatsApp, Maps & media sosial", "Hosting gratis + HTTPS di subdomain gratis", "Pengerjaan 2–3 hari · 1x revisi"],
        },
        {
        ...
        },
        {
          ...
          features: ["Hingga 10 halaman + blog", "Panel admin / CMS untuk kelola konten", "SEO lengkap, sitemap, analytics pengunjung", "Integrasi WhatsApp Business / payment link / Google Maps", "Pengerjaan 2–3 minggu · 3x revisi"],
        },
        {
          name: "Aplikasi Web / Sistem",
          price: "Rp5jt",
          desc: "Aplikasi web custom: sistem manajemen, booking, inventori, atau dashboard internal.",
          features: ["Login multi-role + database terkelola", "Dashboard, laporan & ekspor data", "REST API + integrasi dengan sistem lain milikmu", "Deploy cloud + monitoring dasar", "Pengerjaan 4–6 minggu · garansi bugfix 1 bulan"],
        },
      ],
      enterprise: {
        name: "AI, Otomasi & Enterprise",
        price: "Custom",
        desc: "Chatbot AI berbasis dokumen (RAG), NL2SQL, otomasi alur kerja, computer vision/IoT, atau integrasi enterprise multi-sistem — ruang lingkup dan estimasi disusun setelah sesi discovery gratis.",
        features: ["Analisis kebutuhan & desain arsitektur", "LLM/RAG, agent workflow, evaluasi kualitas", "Pipeline data, streaming & penjadwalan (GCP/AWS)", "Keamanan, monitoring & serah terima terdokumentasi"],
      },
  ...
  detail: {
    ...
    banner: "Produk aslinya bersifat privat — UI, endpoint & arsitektur di sini bersifat ilustratif.",
