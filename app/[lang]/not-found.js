  ...
  return (
    <main className="mx-auto flex min-h-[70svh] max-w-3xl flex-col items-center justify-center px-5 pt-24 text-center">
      ...
      <div className="mt-8 flex flex-wrap justify-center gap-3">
        ...
        <Link href="/en" className="rounded-full border border-white/15 px-6 py-3 text-sm font-medium text-white transition-colors hover:border-iris-500/50 hover:bg-white/5">
          Home (EN)
        </Link>
      </div>
    </main>
